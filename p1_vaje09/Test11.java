public class Test11 {
    ...
    public static void main(String[] args) {
        ...
        Imenik tmp = new Imenik("tmp", new Datoteka[]{
            new BesedilnaDatoteka("memtest86+.etc", 4000),
            new BesedilnaDatoteka("file01", 200),
        });     
        
        Imenik bojan = new Imenik("bojan", new Datoteka[] { sluzba });
        Imenik home = new Imenik("home", new Datoteka[] { ana, bojan });
        Imenik koren = new Imenik("koren", new Datoteka[] { etc, home, tmp });
